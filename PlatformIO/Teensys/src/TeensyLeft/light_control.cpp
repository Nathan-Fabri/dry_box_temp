...
void debugLightControl(float currShellTemperature, float gShellTemp, float error, float pid_output, float currentLevel) {
    SerialUSB1.println("\n--- Light Control Debug ---");
    SerialUSB1.print("Current Shell Temp: ");
    SerialUSB1.print(currShellTemperature);
    SerialUSB1.print("°C, Target: ");
    SerialUSB1.print(gShellTemp);
    ...
    SerialUSB1.print(Kp * error);
    SerialUSB1.print(" I: ");
    SerialUSB1.print(Ki * integral);
    SerialUSB1.print(" D: ");
    SerialUSB1.println(Kd * (error - prevError));
    ...
    SerialUSB1.print("Final dimming level (0=full on, 100=off): ");
    SerialUSB1.println(currentLevel);
    SerialUSB1.println("-------------------------");
}
...
void debugThermalLightControl(float currShellTemperature, float gShellTemp, float error, float pid_output, float currentLevel) {
    ...
    SerialUSB1.print("Current Shell Temp (Thermal): ");
    SerialUSB1.print(currShellTemperature);
    SerialUSB1.print("°C, Target: ");
    SerialUSB1.print(gShellTemp);
    SerialUSB1.println("°C");
    ...
    SerialUSB1.print("Thermal PID Components - P: ");
    SerialUSB1.print(thermalKp * error);
    SerialUSB1.print(" I: ");
    SerialUSB1.print(thermalKi * thermalIntegral);
    SerialUSB1.print(" D: ");
    SerialUSB1.println(thermalKd * (error - thermalPrevError));
