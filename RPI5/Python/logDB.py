...
def load_config():
    ...
    #     "port": int(db_config_raw.get("port")),
    #     "dbname": db_config_raw.get("dbname"),
...
#     temp_hum_pattern = r'✅ (\w+(?:_\w+)*) \| temperature: ([\d.]+) °C \| humidity: ([\d.]+) %RH'
...
def parse_sensor_data_vector(message):
    ...
    for parser in [parse_infrared_sensor_data, parse_temp_humidity_sensor_data, parse_load_cell_sensor_data]:
